...
export default function TrapMassivoGpon() {
  return (
    <GponDocPage
      title="Trap Massivo"
      subtitle="GPON Trap Intelligence — consolidação e análise hierárquica dos traps da rede GPON."
      icon={Siren}
    >
      ...
      <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-foreground">Período de análise</h2>
        </div>
      ...
      <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-foreground">Tabela "Cidades GPON"</h2>
        </div>
        <p className="text-muted-foreground mb-4">
      ...
      <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-foreground">Botão "Ver" — navegação em drill-down</h2>
        </div>
        <p className="text-muted-foreground">
      ...
      <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-foreground">Painel de Ranking (lado direito)</h2>
        </div>
        <p className="text-muted-foreground mb-4">
