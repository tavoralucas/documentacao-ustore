...
import { novidadesGponPorMes } from "@/data/novidadesGpon";
import { useTranslation } from "@/hooks/useTranslation";

export default function NovidadesGpon() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {novidadesGponPorMes.map((m) => (
          <Link key={m.slug} to={`/gpon-360/novidades/${m.slug}`} className="group">
            <Card className="h-full transition-all hover:border-primary hover:shadow-md">
              <CardHeader>
                ...
                <CardDescription>{t('novidades.description')}</CardDescription>
              </CardHeader>
              <CardContent>
